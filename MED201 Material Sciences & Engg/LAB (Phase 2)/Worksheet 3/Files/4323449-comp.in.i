...
fix		2 all deform 1 x erate ${srate1} units box remap x flip yes

# Output strain and stress info to file
# for units metal, pressure is in [bars] = 100 [kPa] = 1/10000 [GPa]
# p2, p3, p4 are in GPa
variable strain equal "(lx - v_L0)/v_L0"
variable strain_compression equal "(v_L0 - lx)/v_L0"
variable p1_compression equal "v_strain_compression"
variable p1 equal "v_strain"
variable p2 equal "-pxx/10000"
variable p3 equal "-pyy/10000"
variable p4 equal "-pzz/10000"
fix def1 all print 100 "${p1_compression} ${p2} ${p3} ${p4}" file Al_SC_100.compression.txt screen no
